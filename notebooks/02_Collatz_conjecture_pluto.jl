...
# ╔═╡ 9b366355-bbe1-411a-8bdd-6d1b2b2eef46
md"""
# Tugas 2: Collatz Conjecture
Ajam Jamaludin\
19/445602/PA/19426\
...
# ╔═╡ d201610d-ba4e-4167-860d-7f07af6874aa
TableOfContents()

# ╔═╡ 20eb9530-ea40-11ed-3cff-b565b2b22e05
md"""
# Batas-batas Fungsi
Syarat:
...
# ╔═╡ 3465c076-e206-43ad-bd10-85284b48211e
md"## Pendefinisian Fungsi"

# ╔═╡ cda24526-2a9b-473c-a615-56b3594c36b8
"""
    to_int(n)
...
# ╔═╡ 5867886d-a112-4aae-bea0-423f68a67d94
"""
...
# ╔═╡ 0ff8204c-0f94-49e1-8f24-b0f40a2f9e41
"""
	plot_total_step(n) 
...
# ╔═╡ e04afa15-b789-4c4c-9df6-9c9c3f766113
md"""## Tes Kasus"""

# ╔═╡ 77f09811-bbf4-4d0a-bb2d-ac150360b30b
md"""
### Parameter Valid
"""

# ╔═╡ f6358b3e-1ce9-4722-bd5d-cfbe05f4638e
collatz_conjecture(5) 

# ╔═╡ 8ff75919-d2a0-4b52-bc33-aaf7097abb87
collatz_conjecture(3+0im) 

# ╔═╡ d8cbc618-4831-429f-ad97-2fa1105b5b27
collatz_conjecture(104//2)

# ╔═╡ eaa58954-7a3d-4550-ad45-cf8dd7a41e8f
collatz_conjecture(9.0) 

# ╔═╡ db1fae32-0d11-4172-ad0b-b796f89a106a
collatz_conjecture("51") 

# ╔═╡ be839ed1-d7ae-48a7-8ed9-6f9905009c53
collatz_conjecture(27)

# ╔═╡ fc9cd52d-e954-4d8f-9ea8-20651019632b
collatz_conjecture("2+0im")

# ╔═╡ 44e0ecc2-1d35-40f7-8312-c51461d75aaf
md"""
### Parameter Tidak Valid
"""

# ╔═╡ e1425950-aa59-4763-8aa9-0b45e9301d74
collatz_conjecture(-1) 

# ╔═╡ 8af44bde-5caa-41c2-99f6-6113d77cba3f
collatz_conjecture(-1.0) 

# ╔═╡ e13feabd-2887-44b4-a64e-d4b1dfe6e30a
collatz_conjecture(12+5im) 

# ╔═╡ 31568c39-07e6-467d-9f17-a6bf1c52b029
collatz_conjecture(-3+0im) 

# ╔═╡ b0966aa0-66a3-41cb-b3d8-103bf97bca22
collatz_conjecture(20//3)

# ╔═╡ aebf286c-2f2b-4586-8b92-ea8981943bfd
collatz_conjecture(-11/3) 
...
md"""
## Visualisasi
### Grafik sequence dari sebuah nomor input
"""

# ╔═╡ 096a2dcc-1df4-475e-9a35-737a9883834b
number = 1000

# ╔═╡ 08ccb3ad-0cb5-47bd-8c00-f9ccf8021891
"""
	plot_cc(n)	
...
function plot_cc(n)
	...
	y = dict["sequence"]
	plot(x, y, label="n = $number",seriestype=:line, fontfamily = "Arial")
