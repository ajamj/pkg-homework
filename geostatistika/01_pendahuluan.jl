...
Bbedanya statistika sama geostatistika itu terletak di sumber datanya. Dalam statistika, datanya diambil dari "ruang sampel" gitu, yang isinya variabel, parameter, dan data statistik spesifik. Sedangkan dalam geostatistika, datanya diambil langsung dari "ruang aslinya" atau ruang fisik di lapangan. Jadi, data geostatistika ini biasanya diukur di tempat-tempat tertentu di dunia nyata, dan kadang juga melibatkan dimensi waktu.
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "49fd0012b1801025acf57559977f735874dbbaad"
