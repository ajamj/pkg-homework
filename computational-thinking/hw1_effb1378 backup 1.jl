...
# ╔═╡ 4c778157-2d07-4f44-b8a3-9c48f193c48b
md"""Hitam putih"""

# ╔═╡ 8dffb277-92f4-4a1e-8bbc-869b3106632e
md"""Sketch"""

# ╔═╡ e78ef4b8-cd68-4473-a4c7-f27508aca726
@bind threshold Slider(0:0.1:1, show_value=true)

# ╔═╡ 6bfd1de0-af87-4a78-b857-b5c94435c89b
using Images, Colors
...
function custom_filter(pixel::AbstractRGB)
    ...
    for i in 1:kernel_size
        for j in 1:kernel_size
            weight = kernel[i, j]
            blurred_r += weight * pixel.r
            blurred_g += weight * pixel.g
            blurred_b += weight * pixel.b
        end
    end
    
    return RGB(blurred_r, blurred_g, blurred_b)
end

function make_gaussian_kernel(size::Int, sigma::Float64)
...
# ╠═fa7b102c-c521-4667-92d2-12a97854cb10
# ╠═bb3f9d03-ed98-4ee9-831d-0dd2548ad09f
# ╠═5be9b144-ee0d-11ea-2a8d-8775de265a1d
# ╠═5da39189-79a5-4b26-b77c-273e70fb218e
# ╠═e372ae05-04a9-45f8-96d6-4ee5d6db5625
...
# ╟─8dffb277-92f4-4a1e-8bbc-869b3106632e
# ╠═e78ef4b8-cd68-4473-a4c7-f27508aca726
# ╠═25bd5d07-fd72-4e62-b3e9-abc7d547764d
# ╠═6bfd1de0-af87-4a78-b857-b5c94435c89b
# ╠═9e5a08dd-332a-486b-94ab-15c49e72e522
# ╟─91f4778e-ee20-11ea-1b7e-2b0892bd3c0f
# ╟─8ffe16ce-ee20-11ea-18bd-15640f94b839
