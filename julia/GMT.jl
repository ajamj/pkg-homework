...
grdimage("@earth_relief_10m.grd", R="90/150/-17/15", J="R15c",  B="a", show=true)
...
# ╔═╡ ef46b1dd-a6d9-4680-8555-e812da033314
begin
	md"""
	$(@bind west Slider(-180:180, default=-180, show_value=true))
	$(@bind east Slider(-180:180, default= 180, show_value=true))
	$(@bind south Slider(-90:90, default= -90, show_value=true))
	$(@bind north Slider(-90:90, default=90, show_value=true))
	"""
end

# ╔═╡ f787c54d-2bc7-494f-b859-de20f0835377
begin
	coast(region=(west,east,south,north), proj=(name=:cylindricalStereographic, center=(0,45)), xaxis=(annot=60, ticks=30), yaxis=(annot=30), res=:crude, area=50, shore=:darkorange, land=:black, ocean=:black, figsize=12, show=true)
end
...
# ╔═╡ 2763a696-4bd8-4845-9cf1-5ff34c77b192
imshow(indonesia, proj=:guess, title="Indonesia")

# ╔═╡ ccef510c-1af2-4ed5-aa69-7f8350ec1b37
id_2 = gadm("IDN", children=true)

# ╔═╡ 3d0d0457-3451-4a86-9dab-d9cfab6f4405
imshow(id_2, proj=:guess, title="Provinces of Indonesia")

# ╔═╡ 49f6eccc-ef27-4182-b4fe-79d9c3773837
gadm("IDN", names=true)

# ╔═╡ c85defbe-2344-43cc-9dce-68e40fe07deb
diy = gadm("IDN", "Yogyakarta", children=true);


# ╔═╡ e37017e0-d77f-47b4-a94c-fd2e9dd623c1
imshow(diy, proj=:guess, title="D.I. Yogyakarta")
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "581c195cd7e9a825ba12bfc7ac5636614600f53a"
