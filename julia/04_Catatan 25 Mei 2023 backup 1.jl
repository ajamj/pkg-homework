...
# ╔═╡ db08cb21-6aa1-4b7b-ae71-3447a056258f
md"""
> julia -t auto
"""

# ╔═╡ c330fe12-7336-4fbe-b182-3b0fd8ccce8a
md"""
auto = jumlah threads
"""

# ╔═╡ 8f270fb5-b454-4c78-a758-0a4c0656f982
...
md"""
@inbounds salah satu untuk optimisasi
"""
...
# ╔═╡ 093230fe-8ab7-447f-a033-cd8442448dda
...
# ╔═╡ aceef9c2-504d-4c28-87a2-3ecc3dee1f71
function lap2d_atomic!(u, new)
	M,N = size(u)
	for j in 2:N-1
		for i in 2:M-1
			@inbounds unew[i,j]=0.25(u[i-1,j]+u[i+1,j]+u[i,j-1]+u[i,j+1])
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "5aedacb2cf0ed2cdfc7f5489e5506ac99ade7f8f"
...
# ╠═aa5c4e32-df0a-4daa-9696-620521091708
# ╠═02019587-9350-4c37-83d4-d57a212bece5
# ╠═96ce8e00-e293-488d-8256-e5be25fcd827
# ╠═4ef3264b-1b7c-42be-9600-0e057e0c5789
# ╠═231b2af3-1738-43eb-880c-520d959a418f
# ╠═39bc533d-8465-4525-a55b-d4d654cf00e4
# ╠═093230fe-8ab7-447f-a033-cd8442448dda
